...
set a specific value for nagios.cfg

	pynag config-set <attr=value> [--filename=/etc/nagios/nagios.cfg]

=head2 config-append

Add a specific attribute to nagios.cfg

	pynag config-append <attr=value> [--filename=/etc/nagios/nagios.cfg]
