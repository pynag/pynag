...
class Model(unittest.TestCase):
    ...
    # Migrated to Model2.test_change_attribute()
    ...
    # Migrated to Model2.test_host_delete()
    ...
    # Migrated to Model2.test_save_existing_object()
    ...
    # Migrated to Model2.test_move_object()
    ...
    # Migrated to Model2.test_parenting()
    ...
    # Migrated to Model2.test_hostgroup_with_regex_members()
    ...
    # Migrated to Model2.test_rewrite()
...
class TestMacroResolving(unittest.TestCase):
    ...
    def test_get_all_macros(self):
        ...
        self.assertEqual('', macros['$_HOST_nonexistant$'])
        self.assertEqual('', macros['$_SERVICE_nonexistant$'])
